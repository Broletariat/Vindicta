/*
custom West German Police/Border Guard
*/
...
_inf set [T_INF_officer, ["GM_BG_TL_rifle","GM_BG_TL_SG","GM_BG_TL_smg"]];
_inf set [T_INF_rifleman, ["GM_BG_rifle","GM_BG_SG","GM_BG_smg"]];
_inf set [T_INF_SL, ["GM_BG_TL_smg","GM_BG_TL_SG","GM_BG_TL_rifle"]];
/*
...
_veh set [T_VEH_DEFAULT, ["gm_ge_pol_typ1200"]]; //TODO: change skin to forest ranger
_veh set [T_VEH_car_unarmed, ["gm_ge_pol_typ1200"]];
