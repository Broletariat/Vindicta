...
_RandomHeadgear = selectRandom ["gm_ge_headgear_beret_grn_infantry","gm_ge_headgear_beret_grn_mechinf","gm_ge_headgear_m62","gm_ge_headgear_m62_net"];
...
this addItemToVest "gm_handgrenade_frag_dm51a1";
